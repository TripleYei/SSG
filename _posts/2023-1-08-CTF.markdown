...
Nos da la pista, de lo siguiente :
...
Le ponemos el objetivo, y tenemos :
...
Se recarga la web, y conseguimos :
...
Miramos en el código fuente, y tenemos el siguiente código JS
...
Si, nos fijamos, podemos sacar lo siguiente :
...
Si lo juntamos, se forma la siguiente bandera
...
Le ponemos el objetivo, y tenemos ya la bandera :
...
Y encontramos la siguiente bandera
~~~~
...
Ponemos el código anterior, y conseguimos :
...
Ponemos el código anterior, y encontramos lo siguiente :
...
La bandera es: hmv{base64decoder}
...
La bandera: HMV{thatwasreallyeazy}
